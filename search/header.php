...
<header class="[ flex ] [ flex_direction_column ]">
    ...
    <nav class="[ flex ] [ align_center ] [ justify_space_between ] [ header_spacing ]">
        ...
        <ol class="flex align_center">
            ...
            <li><span class="profile_pic"><a href="../profile/#"><img src="../profile/<?php echo $defaultProfile;?>" alt="profile picture"></a></span><a href="<?php echo $login; ?>"><?php echo $profileName; ?></a></li>
        </ol>
    </nav>
</header>